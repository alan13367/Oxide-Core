...
pub use crate::scene::{
    ...
    scene_descriptor_dependencies, scene_editor_viewport_system, scene_entity_path,
    scene_instance_id, show_scene_authoring_egui, show_scene_editor_egui, spawn_scene_descriptor,
