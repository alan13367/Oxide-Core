...
pub use crate::scene::{
    ...
    show_scene_authoring_egui, show_scene_editor_egui, spawn_scene_descriptor, spawn_scene_prefab,
    spawn_world_descriptor, take_spawned_oxscene_roots, transform_propagate_system,
    try_spawn_scene_descriptor, try_spawn_scene_prefab, viewport_pick_ray,
    ...
    SceneGizmoLines, SceneMaterialDescriptor, SceneMaterialLibrary, SceneMeshPrimitive,
