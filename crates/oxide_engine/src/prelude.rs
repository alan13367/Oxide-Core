...
pub use crate::scene::{
    attach_child, detach_child, entities_under_scene_path, entities_with_tag, entity_by_scene_path,
    entity_has_tag, first_entity_with_tag, initialize_scene_editor, initialize_scene_renderer,
    ...
    scene_entity_path, show_scene_authoring_egui, show_scene_editor_egui, spawn_scene_descriptor,
    spawn_scene_prefab, spawn_world_descriptor, take_spawned_oxscene_roots,
    ...
    SceneEntitySummary, SceneGizmoLine, SceneGizmoLines, SceneMaterialDescriptor,
