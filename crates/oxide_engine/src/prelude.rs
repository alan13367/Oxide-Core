...
pub use crate::scene::{
    ...
    pick_scene_from_viewport, picking_system, prepare_scene_renderer, queue_oxscene_spawn,
    queue_scene_renderer, record_scene_renderer_stats, register_sprite, reload_changed_oxscenes,
    ...
    scene_descriptor_texture_sources, scene_editor_viewport_system, scene_entity_path,
    scene_instance_id, scene_instance_index, scene_prefab_from_roots, show_scene_authoring_egui,
    show_scene_editor_egui, spawn_scene_descriptor, spawn_scene_descriptor_instance,
    spawn_scene_prefab, spawn_scene_prefab_instance, spawn_world_descriptor,
    take_spawned_oxscene_roots, transform_propagate_system, try_spawn_scene_descriptor,
    try_spawn_scene_descriptor_instance, try_spawn_scene_prefab, try_spawn_scene_prefab_instance,
    viewport_pick_ray, visibility_propagate_system, with_scene_editor, Children, GizmoAxis,
    GlobalTransform, HierarchyCommandsExt, InheritedVisibility, MeshPrimitive, MeshRenderer, Name,
    OxSceneDocument, Parent, PendingOxSceneSpawns, PickEvent, PickEventKind, PickingPlugin,
    PickingState, RenderBounds, RenderCullDistance, RenderLayers, RenderMaterial, RenderMesh,
    ...
    SceneRenderBoundsDescriptor, SceneRenderer, SceneRendererPlugin, SceneRendererStats,
    ...
    SceneWorldSpawnResult, SpawnedOxScenes, SpawnedSceneInstance, SpriteAssets, SpriteBillboard,
    SpriteDepthMode, SpriteFacing, SpriteId, SpriteImage, SpriteImageError, Tags, Terrain,
    TerrainDescriptor, TerrainWaveDescriptor, TransformComponent, Visibility,
    WorldObjectDescriptor, OXSCENE_FORMAT, OXSCENE_VERSION,
};
#[cfg(feature = "gltf-import")]
pub use crate::scene::{
