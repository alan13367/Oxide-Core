...
pub use crate::scene::{
    attach_child, detach_child, entities_under_scene_path, entities_under_scene_path_in_instance,
    entities_with_tag, entities_with_tag_in_instance, entity_by_scene_path,
    entity_by_scene_path_in_instance, entity_has_tag, first_entity_with_tag,
    first_entity_with_tag_in_instance, initialize_scene_editor, initialize_scene_renderer,
    ...
    save_scene_descriptor, scene_descriptor_dependencies, scene_editor_viewport_system,
    scene_entity_path, scene_instance_id, show_scene_authoring_egui, show_scene_editor_egui,
    spawn_scene_descriptor, spawn_scene_prefab, spawn_world_descriptor, take_spawned_oxscene_roots,
    transform_propagate_system, try_spawn_scene_descriptor, try_spawn_scene_prefab,
    ...
    SceneEntitySummary, SceneGizmoLine, SceneGizmoLines, SceneInstanceId, SceneMaterialDescriptor,
    ...
    SpawnedOxScenes, SpriteAssets, SpriteBillboard, SpriteDepthMode, SpriteFacing, SpriteId,
