...
pub use crate::scene::{
    ...
    queue_oxscene_spawn, queue_scene_renderer, record_scene_renderer_stats, register_sprite,
    reload_changed_oxscenes, reload_oxscene_path, request_oxscene_spawn, resize_scene_renderer,
    save_scene_descriptor, scene_descriptor_dependencies, scene_descriptor_from_roots,
    scene_descriptor_from_world, scene_descriptor_texture_sources, scene_editor_viewport_system,
    scene_entity_path, scene_instance_id, scene_instance_index, scene_prefab_from_roots,
    ...
    PendingOxSceneSpawns, RenderBounds, RenderCullDistance, RenderLayers, RenderMaterial,
    RenderMesh, SceneAuthoringPlugins, SceneBuiltinShader, SceneDescriptor, SceneDescriptorAssets,
    SceneEditor, SceneEditorPlugin, SceneEditorTool, SceneEntityDescriptor, SceneEntityKind,
