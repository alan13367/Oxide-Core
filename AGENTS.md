...
- **Post-Process Passes**: Prefer `RenderTexture`, `RenderTextureDescriptor`, and `FullscreenBlitPipeline` from `oxide_renderer` for offscreen color targets, capture/minimap/editor viewport textures, and fullscreen composite passes instead of hand-rolling texture/sampler/pipeline setup in examples.
