...
- **Camera Render Views**: deterministic camera selection with active flags, view ordering, normalized viewports, per-camera clear colors, and render-layer filtering
