...
- **glTF Import Bridging**: imported glTF meshes, materials, images, and transform animation clips are published as labeled Oxide assets, and spawned nodes retain lightweight mesh/material/node references that the automatic scene renderer and animation systems can use
...
- **Transform Animation**: ECS components and systems animate local transforms with tween playback or imported transform clips, including looping, one-shot, and ping-pong playback
...
manually reconstructing node identity.
